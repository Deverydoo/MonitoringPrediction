...
NOTE: This is the legacy Streamlit version.
Use dash_app.py instead for production (15× faster).

Usage:
    python dash_app.py

Requirements:
    pip install dash dash-bootstrap-components plotly requests pandas
"""
...
with col1:
    st.caption("Predictive System Monitoring")
with col2:
...
st.divider()
st.caption("🧭 ArgusAI - Predictive System Monitoring | Built by Craig Giannelli and Claude Code | Legacy Streamlit Version (Use dash_app.py instead)")
