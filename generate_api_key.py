#!/usr/bin/env python3
"""
API Key Generator and Manager for TFT Monitoring System
...
Usage:
    python generate_api_key.py              # Generate new key if none exists
    python generate_api_key.py --force      # Force regenerate even if exists
    python generate_api_key.py --show       # Show current key without regenerating
"""
